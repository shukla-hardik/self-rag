...
│   │   └── internal.py      # Internal system routes
...
│   └── auth.py              # Internal-token and Admin role authentication
│
└── core/
...
- **API Versioning & Routing**: Routers are partitioned by type (Public/Private/Admin/Internal) with specific middleware handling (e.g., Bearer auth for Admin, static key for Internal).